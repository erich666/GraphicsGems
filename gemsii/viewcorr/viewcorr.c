...
void find_corrections( datapts, jacobian, errors, corrections )
ViewData *datapts;
...
void rotate_mat(m, rot_angle, pos_sin_index, neg_sin_index)
	Matrix3 *m;
double rot_angle;
...
void apply_corrections( corrections, view_parms )
Matrix corrections;
ViewParms *view_parms;
{
